...
<div class="wrap">
	...
	<h1>Ekipa pwTRUCK</h1>
	<br/>
   <div class="circle"><a href="info.php">← Wróc</a></div>
   
   <h5>Ekipa serwera pwTRUCK!</h5>
...
<!-- SCORE !-->
	...
	<strong>Nick</strong><label><strong>Poziom admina</strong></label>
	<!--</div>!-->
	<br/>
	</div>
	...
	echo '<li><i class="top-before"></i> '.$ia.'Cruzzer '.$nick.'<label>'.$score.' 6</label>';
	echo '<li><i class="top-before"></i> '.$ia.'AiR '.$nick.'<label>'.$score.' 3</label>';
