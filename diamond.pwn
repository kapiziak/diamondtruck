...
*/
	...
	*/
	...
	stock LoadUser(playerid)
	{
		...
		sscanf(query,"p<|>ddddddddddddddd",PlayerInfo[playerid][UID],PlayerInfo[playerid][Score],PlayerInfo[playerid][Money],PlayerInfo[playerid][Team],PlayerInfo[playerid][VIP],PlayerInfo[playerid][LevelAdmin],PlayerInfo[playerid][Legalne],PlayerInfo[playerid][Nielegalne],PlayerInfo[playerid][Skin],PlayerInfo[playerid][Poziom],PlayerInfo[playerid][ADR],PlayerInfo[playerid][PrawkoA],PlayerInfo[playerid][PrawkoB],PlayerInfo[playerid][PrawkoC],PlayerInfo[playerid][PrawkoD]);
